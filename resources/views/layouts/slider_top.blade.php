        ...
        <div class="container">
          <div class="bnslider-wrapper">
                  ...
                  <div class="bnslider-text-content txt-middle txt-left txt-middle-m txt-center-m">
                    <div class="bnslider-text-content-flex  container ">
                      <div class="bnslider-vert w-s-60 w-ms-80 p-0">
                        <div class="bnslider-text order-2 mt-sm bnslider-text--xl text-center" data-animation="fadeInUp" data-animation-delay="800" data-fontcolor="#ffffff" data-bgcolor="" data-fontweight="600" data-fontline="1.00" data-otherstyle="">{{$slider->title}}</div>
                        <div class="bnslider-text order-3 mt-sm bnslider-text--sm text-center" data-animation="zoomIn" data-animation-delay="1000" data-fontcolor="#ffffff" data-bgcolor="" data-fontweight="500" data-fontline="1.5" data-otherstyle="">Enjoy shopping with Us</div>
                        <div class="bnslider-text order-1 mt-0 bnslider-text--md text-center" data-animation="fadeInDown" data-animation-delay="1600" data-fontcolor="#5378f4" data-bgcolor="" data-fontweight="600" data-fontline="1.00" data-otherstyle=""></div>
            ...
            @endforeach--}}  
              ...
              <a href="#" target="_self" class="bnslider-slide ">
                <div class="bnslider-image-mobile lazyload fade-up-fast" data-bgset="images/skins/electronics/slider/slide-electronics-02-m.png" data-sizes="auto"></div>
                <div class="bnslider-image lazyload fade-up-fast" data-bgset="images/skins/electronics/slider/slide-electronics-02.png" data-sizes="auto"></div>
                <div class="bnslider-text-wrap bnslider-overlay container">
