        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane fade" id="Tab1">
            ...
            <div class="row">
              ...
              <div class="col-md-6"><img width="366px" height="251px" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$product->img_path}}" alt="" class="lazyload"></div>
            </div>
            <div class="row mt-2 align-items-center">
              <div class="col-md-6"><img width="354px" height="251px" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$product->img_path}}" alt="" class="lazyload"></div>
              <div class="col-md-12">
