            ...
            <div class="aside-content">
              ...
              <div class="prd-block_main-image">
                <div class="prd-block_main-image-holder" id="prdMainImage">
                  <div class="product-main-carousel js-product-main-carousel" data-zoom-position="inner">
                    <div data-value="Beige"><span class="prd-img">
                      <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$product->img_path}}" class="lazyload fade-up elzoom" alt="" data-zoom-image="{{$img_url}}{{$product->img_path}}" /></span>
                    </div>
                  <!-- <div>
                ...
                <div class="prd-block_main-image-links">
                  ...
                  <a href="{{$img_url}}{{$product->img_path}}" class="prd-block_zoom-link"><i class="icon-zoom-in"></i></a>
                </div>
              </div>
